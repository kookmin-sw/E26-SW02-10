...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **최승훈** | 소프트웨어학부 | 인공지능, 재태크, 웹 프로그래밍, 데이터 분석 |
| **오준서** | 소프트웨어학부 | 하드웨어, 게임, 알고리즘, 클라우드 |
| **지수연** | 소프트웨어학부 | 인공지능, 금융, 수학, 데이터 분석 |
| **이진형** | 소프트웨어학부 | 앱 프로그래밍, 웹 프로그래밍, 인공지능, 컴퓨터 시스템, 수학 |

### 팀 소개

저희 팀은 행운유수(行雲流水)의 삶을 살아가고 있습니다.

행운유수란?
하늘에 떠가는 구름과 쉬지 않고 흐르는 물'이라는 뜻의 한자 고사성어입니다.



***

## 2️⃣ 공통된 관심사 : 여행, 금융, 영화, 독서, 운동, 과학
